  ...
  return (
    <SectionContainer>
      ...
      <DateRow>
        ...
        <PinButton onClick={() => {}} variant="contained">
          <RoomIcon />
          Pin on map
        </PinButton>
      ...
      <NameRow>
        ...
        <NameFields>
          <ToggleButton
            ...
            onChange={(e) => setLabelType(e.target.checked ? "cenotaph" : null)}
          />
          <Typography sx={{ mb: 2, fontSize: "14px", pl: "58px" }}>
            A cenotaph is a marker within a cemetery placed in honor of a person
            whose remains are elsewhere. It may also be the original marker for
            someone who has since been reinterred elsewhere.
          </Typography>
          <ToggleButton
            label="Label as a monument"
            checked={labelType === "monument"}
            onChange={(e) => setLabelType(e.target.checked ? "monument" : null)}
          />
